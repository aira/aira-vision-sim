...
class HomeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func diseaseArraySetup() {
        diseaseArray.append(Disease(title: "Cataracts",description: "A cataract is a clouding of the lens in the eye that affects vision. Most cataracts are related to aging. Cataracts are very common in older people. By age 80, more than half of all Americans either have a cataract or have had cataract surgery.",areasAffected: "Lens",people: "24.4 Million People in the US and 111.74 million Globally",inherited: false,sources: "NEI",keyFacts: "\u{2022} Blurry vision \n\u{2022} It affects older people more\n\u{2022} Affects 24.4 million  in the US and 111.74  million Globally"))

        diseaseArray.append(Disease(title: "Glaucoma", description: "Glaucoma is a group of diseases that damage the eye’s optic nerve and can result in vision loss and blindness. (tunnel vision)", areasAffected: "Optic Nerve", people: "2.7 million in the US and 64 million globally",inherited: false, sources: "NEI", keyFacts: "\u{2022} Lack of peripheral vision\n\u{2022} Affects 2.7 million in the US and 64 million globally"))

        diseaseArray.append(Disease(title: "Retinitis Pigmentosa (RP)", description: "Retinitis Pigmentosa is a group of rare, genetic disorders that involve a breakdown and loss of cells in the retina. Common symptoms include difficulty seeing at night and a loss of side (peripheral) vision.",areasAffected: "Retina (Photorecepter Cells)", people: "200k in the US and 1.5 million globally",inherited: true, sources: "http://healthresearchfunding.org/, NEI", keyFacts:
        """
        \u{2022} Lack of peripheral vision
        \u{2022} Affects 200k in the US and 1.5 million globally
        """))

        diseaseArray.append(Disease(title: "Diabetic Retinopathy", description: "In some people with diabetic retinopathy, blood vessels may swell and leak fluid. In other people, abnormal new blood vessels grow on the surface of the retina. The retina is the light-sensitive tissue at the back of the eye. A healthy retina is necessary for good vision.", areasAffected: "Retina", people: "7.7 million in the US and 126.6 million globally",inherited: true, sources: "NEI", keyFacts:
        """
        \u{2022} Can't see random portions of their vision
        \u{2022} Affects people with Diabetes
        \u{2022} Affects 7.7 million in the US and 126.6 million globally
        """))

        diseaseArray.append(Disease(title: "Macular Degeneration", description: "Age-related macular degeneration (AMD) is a disease that blurs the sharp, central vision you need for “straight-ahead” activities such as reading, sewing, and driving. AMD affects the macula, the part of the eye that allows you to see fine detail. AMD causes no pain.", areasAffected: "Retina, Macula", people: "2 milion in the US and 196 million globally", inherited: false, sources: "NEI, Apollo Hospital", keyFacts: "\u{2022} Loss of central vision \n\u{2022} One of the most common vision diseases\n\u{2022} Affects 2 milion in the US and 196 million globally"))
