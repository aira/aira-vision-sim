...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    var diseaseArr = ["Glaucoma", "Retinal Detachment", "Optic Neuritis(Neuropathy)", "Leber's Congenital Amaurosis", "Stargardt Disease", "Optic Nerve Hypoplasia", "Cataracts", "Diabetic Retinopathy", "Macular Degeneration", "Corneal Dystrophy", "Retinitis Pigmentosa(RP)", "Bardet Biedle Syndrome", "Neuromyelitis Optica (Devic's Disease)", "LHON"]
    var diseaseTitle = ""
    ...
    func diseaseArraySetup(){
        ...
        diseaseArray.append(Disease(title: "Retinal Detachment", description: "The retina is the light-sensitive layer of tissue that lines the inside of the eye and sends visual messages through the optic nerve to the brain. When the retina detaches, it is lifted or pulled from its normal position. If not promptly treated, retinal detachment can cause permanent vision loss.", areasAffected: "Optic Nerve", people: "< 1 mil cases a year", false, sources: "NEI"))
        diseaseArray.append(Disease(title: "Optic Neuritis(Neuropathy)", description: "Optic neuritis, an inflammation of the optic nerve, can be caused by infection and immune-related illnesses. In many cases, doctors are unable to determine a cause for the neuritis", areasAffected: "optic nerve", people: "15-20% of ppl with multiple sclerosis", true, sources: "NEI"))
